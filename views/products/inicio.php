        ...
        <table class="table table-bordered" >
                ...
                ?>
                    <?php foreach ($sql->fetchAll() as $product) { ?> 
                        ...
                        <td> <?php echo $product['PD_Precio']; ?> </td>
...
<div class="card">
    ...
    <div>
        <a name="" id="" class="btn btn-primary width-100 mt-1" href="?controller=products&accion=crear" role="button">Agregar Producto</a>
    </div>
    </br>
<div class="card">
    <div class="card-header" >
